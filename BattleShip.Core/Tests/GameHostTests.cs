...
//            Guid gameId = gameHost.ExecuteCommand(new CreateGame("My Game", "A", player1Email, "B", player2Email));
...
//            var gameHost = new GameHost();
//
//            Guid game1Id = gameHost.ExecuteCommand(new CreateGame("My Game 1", "A", player1Email, "B", player2Email));
...
//
//            Guid game2Id = gameHost.ExecuteCommand(new CreateGame("My Game 2", "A", player1Email, "B", player2Email));
